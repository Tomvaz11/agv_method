...
1.  **Funcionalidade/Componente Alvo Principal:** `[Item X da Ordem: Nome Completo do Módulo Principal. Ex: "Item 2: meu_projeto.infrastructure.file_system"]` (**ÚNICO CAMPO A SER PREENCHIDO PELO COORDENADOR NESTA SEÇÃO**)
...
10. **Gerar Relatório Detalhado da Implementação:**
    ...
    *   **Estrutura Mandatória para o Relatório:**
        ...
        4.  **Detalhes da Implementação/Modificação de Módulos Base e `utils`.**
        5.  **Detalhes da Geração de Testes Unitários:** Confirme testes para TODO código. Cobertura.
        6.  **Documentação Gerada:** Confirme Docstrings e `README.md`.
        7.  **Resumo da Auto-Revisão Final (Passo 9).**
...
*   Código Python de produção de alta qualidade.
